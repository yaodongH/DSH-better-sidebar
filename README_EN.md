...
- **🗂️ File Workbench**: file explorer (lazy-loading tree) + CodeMirror editor; inline preview for images / Markdown (with Mermaid diagrams, click to enlarge) / HTML / PDF / Office

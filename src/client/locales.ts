...
export const zh = {
  ...
  sideChatThink: '思考过程',
  sideChatCodeToolbarTitle: '代码块',
  sideChatCodeWrap: '自动换行',
  sideChatCodeUnwrap: '取消自动换行',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  sideChatCodeToolbarTitle: 'Code block',
  sideChatCodeWrap: 'Wrap lines',
  sideChatCodeUnwrap: 'Do not wrap lines',
